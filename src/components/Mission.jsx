const Mission = () => {
    return (
      <div id="mission" className="relative min-h-screen bg-[#01204c] flex flex-col justify-center items-center px-6 md:px-12 lg:px-20 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between w-full max-w-6xl gap-8">
          ...
          <div className="text-white flex-1 md:text-left">
            <h1 className="text-2xl md:text-3xl text-center font-bold font-serif mb-6">
              Overview
            </h1>
            <p className="text-md md:text-md lg:text-md font-extralight font-mono leading-relaxed">
